        ...
        if names[i] == name1:
            ...
            if int(num) < 2:
                ...
                for b in range(int(num)):
                    wb[name]['A{}'.format(j+b)] = ws['C{}'.format(a+2)].value
                    wb[name]['B{}'.format(j+b)] = '1'
                    name2 = '{}'.format(ws['K{}'.format(a+2)].value)
                    if name2 == 'None':
                        for k in range(1,30):
                            name3 = '{}'.format(ws['K{}'.format(a+2-k)].value)
                            if name3 == 'None':
                                ...
                                wb[name]['C{}'.format(j+b)] = ws['K{}'.format(a+2-k)].value
                                wb[name]['D{}'.format(j+b)] = ws['L{}'.format(a+2-k)].value
                                wb[name]['E{}'.format(j+b)] = ws['M{}'.format(a+2-k)].value
                                break
                    else:
                        wb[name]['C{}'.format(j+b)] = ws['K{}'.format(a+2)].value
                        wb[name]['D{}'.format(j+b)] = ws['L{}'.format(a+2)].value
                        wb[name]['E{}'.format(j+b)] = ws['M{}'.format(a+2)].value
                j += int(num)
